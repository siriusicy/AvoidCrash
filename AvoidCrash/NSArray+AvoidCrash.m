...
#error NSArray+AvoidCrash.m must be compiled with -fno-objc-arc. ARC inserts autorelease on objectAtIndex: returns; CFArrayGetValueAtIndex / RunLoop observers then leak AutoreleasePoolPages and can OOM.
#endif
